...
Для использования данного приложения потребуется потребуется api ключ бота телеграмм, чтобы его получить воспользуемся официальным телеграмм ботом **@BotFather**
